    ...
    <section className="bg-white py-20 md:py-28">
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        <StaggerContainer className="flex flex-wrap justify-center gap-3" staggerDelay={0.1}>
          {locations.map((loc) => (
            <StaggerItem key={loc.name} animation="scaleUp">
              <div className="inline-flex items-center gap-2 border border-gray-300 rounded-full px-5 py-2.5 text-charcoal text-sm font-medium hover:border-green-primary hover:text-green-primary hover:bg-green-primary/5 transition">
                <svg
