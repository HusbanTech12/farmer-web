    ...
    <section className="py-20 md:py-28">
      <div className="max-w-5xl mx-auto px-6">
        <div className="relative">
          <div className="hidden md:block absolute top-0 left-0 w-36 h-36 rounded-2xl overflow-hidden shadow-lg -translate-x-8 -translate-y-8">
            <div
              className="w-full h-full bg-cover bg-center"
              style={{ backgroundImage: `url('${cornerImages[0]}')` }}
            />
          </div>
          <div className="hidden md:block absolute top-0 right-0 w-36 h-36 rounded-2xl overflow-hidden shadow-lg translate-x-8 -translate-y-8">
            <div
              className="w-full h-full bg-cover bg-center"
              style={{ backgroundImage: `url('${cornerImages[1]}')` }}
            />
          </div>
          <div className="hidden md:block absolute bottom-0 left-0 w-36 h-36 rounded-2xl overflow-hidden shadow-lg -translate-x-8 translate-y-8">
            <div
              className="w-full h-full bg-cover bg-center"
              style={{ backgroundImage: `url('${cornerImages[2]}')` }}
            />
          </div>
          <div className="hidden md:block absolute bottom-0 right-0 w-36 h-36 rounded-2xl overflow-hidden shadow-lg translate-x-8 translate-y-8">
            <div
              className="w-full h-full bg-cover bg-center"
